...
Projectile::Projectile(string _sprite, float _width, float _height, bool _bounce, bool _gravity, float _damage, Vector2 _knockback,  float _explosion_rad, float _time, Worm* _owner, ID3D11Device* _DD) : ImageGO2D(_sprite, _DD)
{
	c_collider = new CollisionComp(_width, _height);
